        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              ...
              <div className="text-gray-400">If you have any questions or encounter any issues, our support team is here to assist you. Reach out to us at [support@votingplatform.com or visit our Help Center for FAQs and guides.</div>
            </div>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; VotingPlatform.com. All rights reserved.</div>
